package com.api.myapplication.view;
...
public class ClockView extends View {
    ...
    public void setTime(int hour, int min, int second) {
        ...
        float v = hour + min * 1.0f / 60f + second * 1.0f / 3600f;
        if (hour >= 12) {
            mIsNight = true;
            mHourDegree = (v - 12) * 30f;
        } else {
            mIsNight = false;
            mHourDegree = (v) * 30f;
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawPoint(getWidth() / 2f, getHeight() / 2f, mPaint);
        ...
        canvas.drawLine(0, 0, 0, -radius / 1.5f, mPaint);
        canvas.restore();
        ...
        canvas.drawLine(0, 0, 0, -radius / 2f, mPaint);
        canvas.restore();
        ...
        canvas.drawLine(0, 0, 0, -radius / 3f, mPaint);
        canvas.restore();
    }
